...
exports.userRegister = async (req, res, next) => {
	try {
		...
		res.status(201).json({ msg: `otp sent to ${req.body.phoneNumber}` })
	} catch (error) {
		next(error);
	}
}
...
exports.userSignin = async (req, res, next) => {
	try {
		...
		if (result.success) {
			res.status(result.status).json({ success: result.success, message: result.message, token: result.access_token })
		} else {
...
exports.getAllUser = async (req, res) => {
	try {
		...
		if (result.success) {
			...
			res.status(res.status).json({ message: result.message, status: result.status, success: result.success })
		}
...
exports.updateUser = async (req, res) => {
	try {
		...
		if (result.success) {
			...
			res.status(result.code).json({ success: result.success, message: result.error })
		}
	} catch (error) {
		throw error
	}
...
exports.DeleteUser = async (req, res) => {
	...
	if (result.success) {
		res.status(result.status).json({ success: result.success, status: result.status, message: result.message, data: result.data })
	} else {
		res.status(result.status).json({ success: result.success, status: result.status, message: result.error })
	}
}
